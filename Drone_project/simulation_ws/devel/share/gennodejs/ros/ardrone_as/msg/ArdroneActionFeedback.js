...
class ArdroneActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new ArdroneFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ArdroneFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ArdroneActionFeedback(null);
    ...
    data.feedback = ArdroneFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ArdroneFeedback.getMessageSize(object.feedback);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ArdroneActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = ArdroneFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new ArdroneFeedback()
    }
...
module.exports = ArdroneActionFeedback;
