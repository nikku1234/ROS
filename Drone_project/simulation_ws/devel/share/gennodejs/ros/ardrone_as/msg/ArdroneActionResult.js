...
class ArdroneActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ArdroneResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static getMessageSize(object) {
    ...
    length += ArdroneResult.getMessageSize(object.result);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ArdroneActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = ArdroneResult.Resolve(msg.result)
    }
    else {
      resolved.result = new ArdroneResult()
    }
...
module.exports = ArdroneActionResult;
